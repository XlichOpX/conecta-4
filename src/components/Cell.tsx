...
export function Cell({
  ...
  return (
    <div
      className={clsx(
        "md:border-3 flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-300 font-bold text-white transition-all sm:h-10 sm:w-10 md:h-16 md:w-16",
